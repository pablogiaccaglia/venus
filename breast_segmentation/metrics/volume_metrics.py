...
def remove_far_masses_based_on_largest_mass(predicted_volume: np.ndarray, 
                                           distance_threshold: float = 50.0) -> np.ndarray:
    """
...
def compute_iou_npy(y_true: np.ndarray, y_pred: np.ndarray, 
                    class_id: int = 1, exclude_empty: bool = False,
                    reduction: str = 'micro') -> float:
    """
...
def compute_dice_score_npy(y_true: np.ndarray, y_pred: np.ndarray, 
                          class_id: int = 1, exclude_empty: bool = False,
                          reduction: str = 'micro') -> float:
    """
