...
def test_dataset_aware_ensemble(model_whole_path: str, model_patches_path: str, patient_ids: List[str], 
                               ...
                               base_channels: int = 64, strict: bool = True) -> Dict:
    """
    Test ensemble model with dataset-aware metric computation.
    """
    # Load models
    model_whole = BreastFusionModel.load_from_checkpoint(model_whole_path, strict=strict, base_channels=base_channels)
