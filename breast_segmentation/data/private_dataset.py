...
PATIENT_INFO = {
    ...
    "SA0379": {
        ...
        "images_len": 156,
        "manufacturer": None,
        "pixel_spacing": [0.6640999913215637, 0.6640999913215637, 1.000067949295044],
    },
    "TS0668": {
        "start": 73,
        "end": 105,
        ...
        "images_len": 160,
        "manufacturer": None,
        "pixel_spacing": [0.7851999998092651, 0.7851999998092651, 0.9000015258789062],
    },
    "MG0477": {
        "start": 46,
        "end": 83,
        ...
        "images_len": 132,
        "manufacturer": None,
        "pixel_spacing": [0.6640999913215637, 0.6640999913215637, 1.0000743865966797],
    },
    "PV0781": {
        "start": 12,
        "end": 129,
    ...
    "VE1077": {
        ...
        "images_len": 188,
        "manufacturer": None,
        "pixel_spacing": [0.7031000256538391, 0.7031000256538391, 1.0000585317611694],
    },
    "BV1252": {
        "start": 96,
        "end": 106,
        ...
        "images_len": 188,
        "manufacturer": None,
        "pixel_spacing": [0.6640999913215637, 0.6640999913215637, 1.0000038146972656],
    },
    "MS0478": {
        "start": 65,
        "end": 168,
        ...
        "images_len": 268,
        "manufacturer": None,
        "pixel_spacing": [0.7422000169754028, 0.7422000169754028, 0.7999954223632812],
    },
    "SS1281": {
        "start": 55,
        "end": 123,
    ...
    "MP140270": {
        ...
        "images_len": 80,
        "manufacturer": None,
        "pixel_spacing": [0.8035714030265808, 0.8035714030265808, 1.7999992370605469],
    },
    "SL191251": {
        "start": 46,
        "end": 49,
        ...
        "images_len": 80,
        "manufacturer": None,
        "pixel_spacing": [0.7589285969734192, 0.7589285969734192, 1.8000030517578125],
    },
    "AM14051962": {
        "start": 95,
        "end": 140,
    ...
    "PBS050277": {
        ...
        "images_len": 88,
        "manufacturer": None,
        "pixel_spacing": [0.8088235259056091, 0.8088235259056091, 1.7999992370605469],
    },
    "SD080569": {
        "start": 85,
        "end": 149,
    ...
    "CMR2703": {
        ...
        "images_len": 88,
        "manufacturer": None,
        "pixel_spacing": [0.6597222089767456, 0.6597222089767456, 1.5999908447265625],
    },
    "CC070764": {
        "start": 117,
        "end": 121,
        ...
        "images_len": 172,
        "manufacturer": None,
        "pixel_spacing": [0.7422000169754028, 0.7422000169754028, 1.000090479850769],
    },
    "CL1007": {
        "start": 39,
        "end": 89,
    ...
    "CS300759": {
        ...
        "images_len": 164,
        "manufacturer": None,
        "pixel_spacing": [0.6640999913215637, 0.6640999913215637, 0.9999688267707825],
    },
    "CG300765": {
        "start": 130,
        "end": 145,
    ...
    "DBR270865": {
        ...
        "images_len": 196,
        "manufacturer": None,
        "pixel_spacing": [0.8202999830245972, 0.8202999830245972, 1.0000746250152588],
    },
    "DOM130370": {
        "start": 66,
        "end": 96,
    ...
    "FP211261": {
        ...
        "images_len": 188,
        "manufacturer": None,
        "pixel_spacing": [0.6640999913215637, 0.6640999913215637, 1.0000680685043335],
    },
    "GF220280": {
        "start": 82,
        "end": 134,
        ...
        "images_len": 208,
        "manufacturer": None,
        "pixel_spacing": [0.6640999913215637, 0.6640999913215637, 0.9994816184043884],
    },
    "HMLL020999": {
        "start": 82,
        "end": 161,
    ...
    "LL010972": {
        ...
        "images_len": 175,
        "manufacturer": None,
        "pixel_spacing": [0.5932203531265259, 0.5932203531265259, 1.000002145767212],
    },
    "MP140370": {
        "start": 62,
        "end": 119,
    ...
    "MP160849": {
        ...
        "images_len": 188,
        "manufacturer": None,
        "pixel_spacing": [0.6640999913215637, 0.6640999913215637, 1.0000649690628052],
    },
    "PM090847": {
        "start": 0,
        "end": 27,
    ...
    "RHCL031174": {
        ...
        "images_len": 188,
        "manufacturer": None,
        "pixel_spacing": [0.8202999830245972, 0.8202999830245972, 0.9999658465385437],
    },
    "MDSE060863": {
        "start": 50,
        "end": 59,
...
# Patients to exclude
PATIENTS_TO_EXCLUDE = ["CMG0948", "IM0544(1,5)B-merged", "D2MP8(VR)", "VC0285(1,5)B-merged"]
...
def get_filenames(
    ...
    remove_picked_samples: bool = False,
    ...
    for idx, patient_id in enumerate(patient_ids):
        ...
        if get_random_samples_and_remove_black_samples:
            ...
            random_samples_indexes = (
                None if create_random_samples_index_list else random_samples_indexes_list[idx]
            )
            files_random, random_samples_indexes = get_samples_size(
                files=files,
                patient_id=patient_id,
                size=size,
                random_samples=True,
                random_samples_indexes=random_samples_indexes,
            )
            ...
            size = int(len(files_sampled) * 0.25)
            files_top_bottom = get_samples_size(
                files=files, patient_id=patient_id, size=size, random_samples=False
            )
...
def get_samples_size(
    ...
    top_slices_len = PATIENT_INFO[patient_id]["start"]
    top_slices = files[:top_slices_len]
    sample_size_top_slices = size

    bottom_slices_len = len(files) - PATIENT_INFO[patient_id]["end"]
    bottom_slices = files[PATIENT_INFO[patient_id]["end"] :]
    ...
    if random_samples:
        if random_samples_indexes:
            ...
            subset_top_slices_random_indexes = random.sample(
                range(len(top_slices)), sample_size_top_slices
            )
        ...
        if random_samples_indexes:
            ...
            subset_bottom_slices_random_indexes = random.sample(
                range(len(bottom_slices)), sample_size_bottom_slices
            )
        ...
        return files_to_return, [
            subset_top_slices_random_indexes,
            subset_bottom_slices_random_indexes,
        ]
...
def get_train_val_test_dicts(
    dataset_base_path: str, x_train: List[str], x_val: List[str], x_test: List[str]
    ...
    train_dicts = [
        ...
        for image_name, label_name in zip(train_images_fnames, train_masks_fnames)
    ]
    val_dicts = [
        {"image": image_name, "label": label_name}
        for image_name, label_name in zip(val_images_fnames, val_masks_fnames)
    ]
    test_dicts = [
        {"image": image_name, "label": label_name}
        for image_name, label_name in zip(test_images_fnames, test_masks_fnames)
    ]
